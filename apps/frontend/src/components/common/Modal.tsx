// Endereço: apps/frontend/src/components/common/Modal.tsx (Com Estilo Glassmorphism)
'use client';

import { Dialog, Transition } from '@headlessui/react';
import { Fragment, ReactNode } from 'react';
import { X } from 'lucide-react';
import styles from './Modal.module.css'; // 1. Importa nosso novo CSS Module
    ...
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          {/* 2. Aplica a classe de backdrop aqui */}
